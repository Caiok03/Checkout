 ...
 * @author Pichau
 */
public class Cancelada extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Compra cancelada");

        btNovaCompra.setText("Inicar nova compra");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cancelada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
